...
const { clone, cloneDeep } = __webpack_require__(38);
...
const { isPromise } = __webpack_require__(10);
const { after } = __webpack_require__(39);
const { afterReturn } = __webpack_require__(40);
const { mapAfterAllReturn } = __webpack_require__(41);
const { promiseMap } = __webpack_require__(42);
const { promiseTry } = __webpack_require__(43);
...
const { isObject, isFunction } = __webpack_require__(0);
...
const { QueryBuilderOperation } = __webpack_require__(2);
const { isPlainObject, isObject, isFunction, once } = __webpack_require__(0);
const { isKnexQueryBuilder, isKnexJoinBuilder } = __webpack_require__(4);
const getJoinBuilder = once(() => __webpack_require__(111).JoinBuilder);
...
const { Model: NativeModel } = __webpack_require__(18);
const { QueryBuilder: NativeQueryBuilder } = __webpack_require__(70);
const { QueryBuilderBase } = __webpack_require__(73);
const { QueryBuilderOperation } = __webpack_require__(2);
const { RelationExpression } = __webpack_require__(11);
const { ValidationError } = __webpack_require__(8);
const { NotFoundError } = __webpack_require__(85);
const { AjvValidator: NativeAjvValidator } = __webpack_require__(68);
const { Validator: NativeValidator } = __webpack_require__(69);
const { Relation } = __webpack_require__(35);
const { HasOneRelation } = __webpack_require__(86);
const { HasManyRelation } = __webpack_require__(52);
const { BelongsToOneRelation } = __webpack_require__(89);
const { HasOneThroughRelation } = __webpack_require__(90);
const { ManyToManyRelation } = __webpack_require__(56);
const { transaction } = __webpack_require__(179);
...
const { compose, mixin } = __webpack_require__(54);
const { ref } = __webpack_require__(14);
const { lit } = __webpack_require__(180);
const { raw } = __webpack_require__(44);

const { inherit } = __webpack_require__(13);
...
const { asArray, isString } = __webpack_require__(0);
...
const parser = __webpack_require__(107);
const { isObject, isNumber, isString, union } = __webpack_require__(0);
const { RelationDoesNotExistError } = __webpack_require__(71);
...
const { parseFieldExpression } = __webpack_require__(28);
...
const { asArray, isString, isFunction, isPlainObject } = __webpack_require__(0);
...
const { clone } = __webpack_require__(62);
const { bindKnex } = __webpack_require__(95);
const { validate } = __webpack_require__(96);
const { isMsSql } = __webpack_require__(4);
const { omit, pick } = __webpack_require__(97);
const { visitModels } = __webpack_require__(98);
const { hasId, getSetId } = __webpack_require__(99);
const { map: promiseMap } = __webpack_require__(1);
const { toJson, toDatabaseJson } = __webpack_require__(100);
const { values, propKey, hasProps } = __webpack_require__(66);
const { defineNonEnumerableProperty } = __webpack_require__(9);
const { parseRelationsIntoModelInstances } = __webpack_require__(67);
const { fetchTableMetadata, tableMetadata } = __webpack_require__(101);
const { asArray, isFunction, isString, asSingle } = __webpack_require__(0);
const { setJson, setFast, setRelated, appendRelated, setDatabaseJson } = __webpack_require__(102);
const {
  getJsonAttributes,
  parseJsonAttributes,
  formatJsonAttributes
} = __webpack_require__(103);
const { columnNameToPropertyName, propertyNameToColumnName } = __webpack_require__(104);

const { raw } = __webpack_require__(44);
const { ref } = __webpack_require__(14);

const { AjvValidator } = __webpack_require__(68);
const { QueryBuilder } = __webpack_require__(70);
const { NotFoundError } = __webpack_require__(85);
const { ValidationError } = __webpack_require__(8);
const { ModifierNotFoundError } = __webpack_require__(151);
const { RelationProperty } = __webpack_require__(51);
...
const { InstanceFindOperation } = __webpack_require__(175);
const { InstanceInsertOperation } = __webpack_require__(176);
const { InstanceUpdateOperation } = __webpack_require__(177);
const { InstanceDeleteOperation } = __webpack_require__(178);
...
const { ref } = __webpack_require__(14);
const { isEmpty } = __webpack_require__(0);
const { after, afterReturn } = __webpack_require__(1);
const { isKnexRaw, isKnexQueryBuilder } = __webpack_require__(4);
const { QueryBuilderOperation } = __webpack_require__(2);
const { StaticHookArguments } = __webpack_require__(30);
...
const { QueryBuilderOperation } = __webpack_require__(2);
const { StaticHookArguments } = __webpack_require__(30);
const { after, mapAfterAllReturn, afterReturn } = __webpack_require__(1);
const { isPostgres, isSqlite, isMySql } = __webpack_require__(4);
const { isObject } = __webpack_require__(0);
...
const { asArray, groupBy } = __webpack_require__(0);
const { ModelGraph } = __webpack_require__(81);
const { FetchStrategy } = __webpack_require__(83);
const { RelationExpression } = __webpack_require__(11);
...
const { isPostgres } = __webpack_require__(4);
...
const jsonFieldExpressionParser = __webpack_require__(105);
const cache = new Map();
...
const { asArray } = __webpack_require__(0);
...
const { RelationProperty } = __webpack_require__(51);
const getModel = () => __webpack_require__(18).Model;

const { RelationFindOperation } = __webpack_require__(87);
const { RelationUpdateOperation } = __webpack_require__(152);
const { RelationDeleteOperation } = __webpack_require__(88);
const { RelationSubqueryOperation } = __webpack_require__(153);

const { ref } = __webpack_require__(14);
const { isSubclassOf } = __webpack_require__(13);
const { resolveModel } = __webpack_require__(36);
const { get, isFunction } = __webpack_require__(0);
const { mapAfterAllReturn } = __webpack_require__(1);
const { createModifier } = __webpack_require__(16);
...
const path = __webpack_require__(154);
const { once, isString, isFunction } = __webpack_require__(0);
const { isSubclassOf } = __webpack_require__(13);

const getModel = once(() => __webpack_require__(18).Model);
...
function requireModel(modelPath) {
   ...
   */
  let mod = __webpack_require__(155)(`${path.resolve(modelPath)}`);
  let modelClass = null;
...
const { isPlainObject } = __webpack_require__(0);
const { buildArg } = __webpack_require__(27);
...
const { isString, isObject } = __webpack_require__(0);
...
const { ObjectionToKnexConvertingOperation } = __webpack_require__(5);
...
const parser = __webpack_require__(28);
const { asArray, isObject, isString } = __webpack_require__(0);
...
const { QueryBuilderOperation } = __webpack_require__(2);
const { StaticHookArguments } = __webpack_require__(30);
const { isPromise, after, afterReturn } = __webpack_require__(1);
const { isObject } = __webpack_require__(0);
...
const { asArray, isObject, uniqBy, get, set } = __webpack_require__(0);
const { ref: createRef } = __webpack_require__(14);
const { propToStr, PROP_KEY_PREFIX } = __webpack_require__(66);
...
const { Relation } = __webpack_require__(35);
const { HasManyInsertOperation } = __webpack_require__(156);
const { HasManyRelateOperation } = __webpack_require__(157);
const { HasManyUnrelateOperation } = __webpack_require__(158);
...
const { after } = __webpack_require__(1);
const { InsertOperation } = __webpack_require__(20);
...
const { ref } = __webpack_require__(14);
const { isSqlite, isMySql } = __webpack_require__(4);
const { inheritModel } = __webpack_require__(64);
const { resolveModel } = __webpack_require__(36);
const { mapAfterAllReturn } = __webpack_require__(1);
const { isFunction, isObject } = __webpack_require__(0);

const { ManyToManyFindOperation } = __webpack_require__(159);
const { ManyToManyInsertOperation } = __webpack_require__(160);
const { ManyToManyRelateOperation } = __webpack_require__(161);

const { ManyToManyUnrelateOperation } = __webpack_require__(162);
const { ManyToManyUnrelateMySqlOperation } = __webpack_require__(163);
const {
  ManyToManyUnrelateSqliteOperation
} = __webpack_require__(164);

const { ManyToManyUpdateOperation } = __webpack_require__(165);
const { ManyToManyUpdateMySqlOperation } = __webpack_require__(166);
const { ManyToManyUpdateSqliteOperation } = __webpack_require__(167);

const { ManyToManyDeleteOperation } = __webpack_require__(168);
const { ManyToManyDeleteMySqlOperation } = __webpack_require__(169);
const { ManyToManyDeleteSqliteOperation } = __webpack_require__(170);
...
const { UnrelateOperation } = __webpack_require__(33);
...
const { ManyToManyModifyMixin } = __webpack_require__(26);
...
const { UpdateOperation } = __webpack_require__(19);
...
const { DeleteOperation } = __webpack_require__(31);
...
const { isObject, cloneDeep } = __webpack_require__(0);
const { hiddenProps } = __webpack_require__(9);
const { defineNonEnumerableProperty } = __webpack_require__(9);
const { isInternalProp } = __webpack_require__(12);
...
const { Validator } = __webpack_require__(69);
const { ValidationErrorType } = __webpack_require__(8);
const { isObject, once, cloneDeep: lodashCloneDeep, omit } = __webpack_require__(0);
...
const { createModifier } = __webpack_require__(16);
const { ValidationErrorType } = __webpack_require__(8);
const { isObject, isString, isFunction, last } = __webpack_require__(0);
const { RelationExpression, DuplicateRelationError } = __webpack_require__(11);
const { Selection } = __webpack_require__(46);

const { QueryBuilderContext } = __webpack_require__(108);
const { QueryBuilderBase } = __webpack_require__(73);

const { FindOperation } = __webpack_require__(49);
const { DeleteOperation } = __webpack_require__(31);
const { UpdateOperation } = __webpack_require__(19);
const { InsertOperation } = __webpack_require__(20);
const { RelateOperation } = __webpack_require__(32);
const { UnrelateOperation } = __webpack_require__(33);

const { JoinEagerOperation } = __webpack_require__(120);
const { NaiveEagerOperation } = __webpack_require__(125);
const { WhereInEagerOperation } = __webpack_require__(78);

const { InsertGraphAndFetchOperation } = __webpack_require__(126);
const { UpsertGraphAndFetchOperation } = __webpack_require__(137);
const { InsertAndFetchOperation } = __webpack_require__(138);
const { UpdateAndFetchOperation } = __webpack_require__(139);
const { JoinRelationOperation } = __webpack_require__(140);
const { OnBuildKnexOperation } = __webpack_require__(141);
const { InsertGraphOperation } = __webpack_require__(79);
const { UpsertGraphOperation } = __webpack_require__(84);
const { RunBeforeOperation } = __webpack_require__(142);
const { RunAfterOperation } = __webpack_require__(143);
const { FindByIdOperation } = __webpack_require__(144);
const { FindByIdsOperation } = __webpack_require__(145);
const { OnBuildOperation } = __webpack_require__(146);
const { OnErrorOperation } = __webpack_require__(147);
const { SelectOperation } = __webpack_require__(75);
const { EagerOperation } = __webpack_require__(50);
const { RangeOperation } = __webpack_require__(148);
const { FirstOperation } = __webpack_require__(149);
const { FromOperation } = __webpack_require__(150);
const { KnexOperation } = __webpack_require__(47);
...
const { InternalOptions } = __webpack_require__(109);
...
const { QueryBuilderOperationSupport } = __webpack_require__(74);
const { isSqlite, isMsSql } = __webpack_require__(4);

const { KnexOperation } = __webpack_require__(47);
const { SelectOperation } = __webpack_require__(75);
const { ReturningOperation } = __webpack_require__(112);
const { WhereCompositeOperation } = __webpack_require__(113);
const { WhereJsonPostgresOperation } = __webpack_require__(114);
...
const promiseUtils = __webpack_require__(1);

const { isSubclassOf } = __webpack_require__(13);
const { isString, isFunction, isRegExp, last } = __webpack_require__(0);
const { QueryBuilderOperation } = __webpack_require__(2);
const { QueryBuilderContextBase } = __webpack_require__(72);
const { QueryBuilderUserContext } = __webpack_require__(110);
...
const { uniqBy } = __webpack_require__(0);
const { Selection } = __webpack_require__(46);
const { createModifier } = __webpack_require__(16);
const { map: mapPromise } = __webpack_require__(1);
const { ValidationErrorType } = __webpack_require__(8);

const { TableTree } = __webpack_require__(121);
const { JoinResultParser } = __webpack_require__(123);
const { ID_LENGTH_LIMIT } = __webpack_require__(77);
...
const { EagerOperation } = __webpack_require__(50);
const { isMsSql, isOracle } = __webpack_require__(4);
const { asArray, flatten, chunk } = __webpack_require__(0);
const { ValidationErrorType } = __webpack_require__(8);
const { createModifier } = __webpack_require__(16);
const { RelationDoesNotExistError } = __webpack_require__(71);
...
const { DelegateOperation } = __webpack_require__(21);
const { InsertOperation } = __webpack_require__(20);
const { GraphUpsert } = __webpack_require__(80);
...
const { ModelGraph } = __webpack_require__(81);
const { createNotModelError } = __webpack_require__(82);
const { GraphOperation } = __webpack_require__(22);
const { GraphInsert } = __webpack_require__(128);
const { GraphPatch } = __webpack_require__(131);
const { GraphDelete } = __webpack_require__(133);
const { GraphRecursiveUpsert } = __webpack_require__(135);
const { GraphOptions } = __webpack_require__(83);
const { ValidationErrorType } = __webpack_require__(8);
const { RelationExpression } = __webpack_require__(11);
const { uniqBy, asArray, isObject } = __webpack_require__(0);
...
const { ModelGraphBuilder } = __webpack_require__(82);
...
const { isObject, isString, asArray, asSingle } = __webpack_require__(0);
const { ValidationErrorType } = __webpack_require__(8);
const { ModelGraphNode } = __webpack_require__(127);
const { ModelGraphEdge } = __webpack_require__(34);
...
const { Relation } = __webpack_require__(35);
const { BelongsToOneInsertOperation } = __webpack_require__(171);
const { BelongsToOneDeleteOperation } = __webpack_require__(172);
const { BelongsToOneRelateOperation } = __webpack_require__(173);
const { BelongsToOneUnrelateOperation } = __webpack_require__(174);
...
const { inheritModel } = __webpack_require__(64);
const { staticHiddenProps } = __webpack_require__(9);
const { defineNonEnumerableProperty } = __webpack_require__(9);
...
const { isInternalProp } = __webpack_require__(12);
const { mergeQueryProps } = __webpack_require__(65);
const { isObject, cloneDeep, isFunction } = __webpack_require__(0);
const EMPTY_ARRAY = [];
...
const { defineNonEnumerableProperty } = __webpack_require__(9);
const { isPromise } = __webpack_require__(1);
...
const { isInternalProp } = __webpack_require__(12);
const { splitQueryProps } = __webpack_require__(65);
const { isFunction, isString } = __webpack_require__(0);
const { parseRelationsIntoModelInstances } = __webpack_require__(67);
...
const { asArray, isObject, flatten, isString } = __webpack_require__(0);
...
const { difference } = __webpack_require__(0);
...
const { ObjectionToKnexConvertingOperation } = __webpack_require__(5);
const { asSingle } = __webpack_require__(0);
...
const jsonApi = __webpack_require__(48);
const { ObjectionToKnexConvertingOperation } = __webpack_require__(5);
...
const { ObjectionToKnexConvertingOperation } = __webpack_require__(5);
const { isObject, asSingle } = __webpack_require__(0);
const { isKnexQueryBuilder } = __webpack_require__(4);
...
const { ObjectionToKnexConvertingOperation } = __webpack_require__(5);
const { flatten, zipObject, isString } = __webpack_require__(0);
const { getTempColumn } = __webpack_require__(29);
...
const { EagerOperation } = __webpack_require__(50);
const { RelationJoiner } = __webpack_require__(76);
...
const { forEachChildExpression } = __webpack_require__(77);
const { TableNode } = __webpack_require__(122);
...
const { JoinResultColumn } = __webpack_require__(124);
const { groupBy } = __webpack_require__(0);
...
const { JoinRowGraphInsertAction } = __webpack_require__(129);
const { GraphInsertAction } = __webpack_require__(130);
const { GraphOperation } = __webpack_require__(22);
const { ModelGraphEdge } = __webpack_require__(34);
...
const { GraphAction } = __webpack_require__(23);
const { groupBy, chunk } = __webpack_require__(0);
const promiseUtils = __webpack_require__(1);
...
const { GraphAction } = __webpack_require__(23);
const { groupBy, chunk, get, set } = __webpack_require__(0);
const { ModelGraphEdge } = __webpack_require__(34);
const promiseUtils = __webpack_require__(1);
...
const { GraphOperation } = __webpack_require__(22);
const { GraphPatchAction } = __webpack_require__(132);
...
const { GraphAction } = __webpack_require__(23);
const { isInternalProp } = __webpack_require__(12);
const { union, difference, isObject, jsonEquals } = __webpack_require__(0);
const promiseUtils = __webpack_require__(1);
...
const { GraphOperation } = __webpack_require__(22);
const { GraphDeleteAction } = __webpack_require__(134);
...
const { GraphOperation } = __webpack_require__(22);
const { GraphRecursiveUpsertAction } = __webpack_require__(136);
...
const { InsertOperation } = __webpack_require__(20);
const { DelegateOperation } = __webpack_require__(21);
const { keyByProps } = __webpack_require__(9);
const { asArray } = __webpack_require__(0);
const { after } = __webpack_require__(1);
...
const { DelegateOperation } = __webpack_require__(21);
const { UpdateOperation } = __webpack_require__(19);
const { afterReturn } = __webpack_require__(1);
...
const { ObjectionToKnexConvertingOperation } = __webpack_require__(5);
const { isPlainObject, isString } = __webpack_require__(0);
...
var map = {
	...
	"./clone.js": 38,
	"./createModifier": 16,
	"./createModifier.js": 16,
	"./deprecate": 15,
	"./deprecate.js": 15,
	"./identifierMapping": 53,
	"./identifierMapping.js": 53,
	"./internalPropUtils": 12,
	"./internalPropUtils.js": 12,
	"./knexUtils": 4,
	"./knexUtils.js": 4,
	"./mixin": 54,
	"./mixin.js": 54,
	...
	"./objectUtils": 0,
	"./objectUtils.js": 0,
	"./parseFieldExpression": 28,
	"./parseFieldExpression.js": 28,
	"./promiseUtils": 1,
	"./promiseUtils/": 1,
	"./promiseUtils/after": 39,
	"./promiseUtils/after.js": 39,
	"./promiseUtils/afterReturn": 40,
	"./promiseUtils/afterReturn.js": 40,
	"./promiseUtils/index": 1,
	"./promiseUtils/index.js": 1,
	"./promiseUtils/isPromise": 10,
	"./promiseUtils/isPromise.js": 10,
	"./promiseUtils/map": 42,
	"./promiseUtils/map.js": 42,
	"./promiseUtils/mapAfterAllReturn": 41,
	"./promiseUtils/mapAfterAllReturn.js": 41,
	"./promiseUtils/try": 43,
	"./promiseUtils/try.js": 43,
	"./resolveModel": 36,
	"./resolveModel.js": 36,
	"./tmpColumnUtils": 29,
	"./tmpColumnUtils.js": 29
};
...
const { RelationInsertOperation } = __webpack_require__(55);
const { after } = __webpack_require__(1);
...
const { normalizeIds } = __webpack_require__(25);
const { RelateOperation } = __webpack_require__(32);
...
const { ManyToManyUnrelateOperationBase } = __webpack_require__(57);
const { ManyToManyModifyMixin } = __webpack_require__(26);
...
const { ManyToManyUnrelateOperationBase } = __webpack_require__(57);
const { ManyToManyMySqlModifyMixin } = __webpack_require__(58);
...
const { ManyToManyUnrelateOperationBase } = __webpack_require__(57);
const { ManyToManySqliteModifyMixin } = __webpack_require__(59);
...
const { ManyToManyUpdateOperationBase } = __webpack_require__(60);
const { ManyToManyModifyMixin } = __webpack_require__(26);
...
const { ManyToManyDeleteOperationBase } = __webpack_require__(61);
const { ManyToManyModifyMixin } = __webpack_require__(26);
...
const { FindOperation } = __webpack_require__(49);
const { assertHasId } = __webpack_require__(24);
...
const { DeleteOperation } = __webpack_require__(31);
const { assertHasId } = __webpack_require__(24);
const { afterReturn, after } = __webpack_require__(1);
...
const Bluebird = __webpack_require__(45);
const { Model } = __webpack_require__(18);
const promiseUtils = __webpack_require__(1);
const { isSubclassOf } = __webpack_require__(13);
const { isFunction } = __webpack_require__(0);
...
const { asArray, isObject } = __webpack_require__(0);
const { buildArg } = __webpack_require__(27);
const { deprecate } = __webpack_require__(15);
...
var register_ = __webpack_require__(3);

// EXTERNAL MODULE: external "apollo-server-lambda"
var external_apollo_server_lambda_ = __webpack_require__(6);

// CONCATENATED MODULE: ./typeDefs/user.js

/* harmony default export */ var typeDefs_user = (`
type User {
  id: String,
  client_id: String,
  username: String,
...
`);
// CONCATENATED MODULE: ./typeDefs/index.js



/* harmony default export */ var typeDefs = (external_apollo_server_lambda_["gql"]`
  scalar Date
  ${typeDefs_user}
  type Query {
    _empty: String
...
var external_graphql_ = __webpack_require__(91);

// EXTERNAL MODULE: external "graphql/language"
var language_ = __webpack_require__(92);

// EXTERNAL MODULE: ../node_modules/objection/lib/objection.js
var objection = __webpack_require__(7);

// CONCATENATED MODULE: ./models/user.js


class user_AdvitoUser extends objection["Model"] {
  ...
  static get relationMappings() {
    return {
      advitoUserRoleLink: {
        ...
        modelClass: user_AdvitoUserRoleLink,
        join: {
          from: 'advito_user.id',
      ...
      advitoUserSession: {
        relation: objection["Model"].HasManyRelation,
        modelClass: user_AdvitoUserSession,
        join: {
          from: 'advito_user.id',
...
class user_AdvitoUserRoleLink extends objection["Model"] {
  static get tableName() {
    return 'advito_user_role_link';
  }

}
class user_AdvitoUserSession extends objection["Model"] {
  static get tableName() {
    return 'advito_user_session';
  }

}
class user_AccessToken extends objection["Model"] {
  static get tableName() {
    return 'access_token';
  }

}
class user_EmailTemplate extends objection["Model"] {
  static get tableName() {
...
var external_crypto_ = __webpack_require__(17);
var external_crypto_default = /*#__PURE__*/__webpack_require__.n(external_crypto_);

// CONCATENATED MODULE: ./constants/user.js
...
// CONCATENATED MODULE: ./util/password.js



const saltHash = (password, salt = null) => {
  const saltHashed = salt || external_crypto_default.a.randomBytes(16).toString('base64');
  const passwordHashed = external_crypto_default.a.createHash('sha256').update(password).update(saltHashed, 'base64').digest('base64');
  return {
    saltHashed,
    passwordHashed
  };
};
const generateAccessToken = (prefix = '') => prefix + external_crypto_default.a.randomBytes(16).toString('hex');
...
var external_aws_sdk_ = __webpack_require__(37);
...
// CONCATENATED MODULE: ./util/email.js




const ses = new external_aws_sdk_default.a.SES({
...
const sendEmail = async (templateName, recipient, placeholders) => {
  ...
  } = await user_EmailTemplate.query().where('template_name', templateName).where('advito_application_id', ADVITO_AIR_APPLICATION).first();
...
// CONCATENATED MODULE: ./resolvers/user.js
...
/* harmony default export */ var resolvers_user = ({
  Query: {
    getUser: async (_, __) => user_AdvitoUser.query().findById(711)
  },
  Mutation: {
    login: async (_, {
      username,
      ...
      const user = await user_AdvitoUser.query().where('username', username).first();
      if (!user) throw new external_apollo_server_lambda_["AuthenticationError"]('User not found');
      if (!user.is_enabled) throw new external_apollo_server_lambda_["AuthenticationError"]('User is not enabled');
      const {
        pwd: dbPassword,
        user_salt: userSalt
      } = user;
      const {
        passwordHashed
      } = saltHash(password, userSalt);
      if (dbPassword !== passwordHashed) throw new external_apollo_server_lambda_["AuthenticationError"]('Password is incorrect`');
      ...
      const sessionToken = external_crypto_default.a.randomBytes(16).toString('base64');
    ...
    logout: async (_, {
      ...
      const session = await user_AdvitoUserSession.query().where('session_token', sessionToken).where('session_end', null).first();
      if (!session) throw new external_apollo_server_lambda_["AuthenticationError"]('User session not found');
      await user_AdvitoUserSession.query().patch({
        session_end: new Date()
    ...
    sendResetPasswordEmail: async (_, {
      ...
      const user = await user_AdvitoUser.query().where('email', email).first();
      if (!user) throw new external_apollo_server_lambda_["AuthenticationError"]('User not found');
      const oldToken = await user.$relatedQuery('accessToken').where('is_active', true).first();
      if (oldToken) await await user.$relatedQuery('accessToken').patch({
        is_active: false
      ...
      try {
        ...
        throw new external_apollo_server_lambda_["ForbiddenError"](err.message);
      }
    }
  }
});
// EXTERNAL MODULE: ../node_modules/lodash.merge/index.js
var lodash_merge = __webpack_require__(93);
...
/* harmony default export */ var resolvers = ({ ...lodash_merge_default()(resolvers_user),
  Date: new external_graphql_["GraphQLScalarType"]({
    name: 'Date',
    ...
    parseLiteral(ast) {
      if (ast.kind === language_["Kind"].INT) {
...
// CONCATENATED MODULE: ./playground/user.js


/* harmony default export */ var playground_user = ({
  Query: {
    name: 'User Queries',
    endpoint: '',
    headers: {
...
// CONCATENATED MODULE: ./playground/index.js


/* harmony default export */ var playground = ({
  tabs: [playground_user.Query, playground_user.Mutation]
});
// EXTERNAL MODULE: external "knex"
var external_knex_ = __webpack_require__(94);
...
const db = external_knex_default()({
  client: 'pg',
  connection: {
...
const server = new external_apollo_server_lambda_["ApolloServer"]({
  typeDefs: typeDefs,
  resolvers: resolvers,
  context: async ({
    event
