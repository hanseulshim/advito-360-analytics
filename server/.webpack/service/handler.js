...
/*!*************************!*\
  !*** ./models/index.js ***!
  \*************************/
/*! exports provided: AdvitoUser, AdvitoUserRoleLink, AdvitoUserSession, AccessToken */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  Mutation: {
    login: async (_, {
      ...
      if (!user) throw new apollo_server_lambda__WEBPACK_IMPORTED_MODULE_1__["AuthenticationError"]('User not found');
      if (!user.is_enabled) throw new apollo_server_lambda__WEBPACK_IMPORTED_MODULE_1__["AuthenticationError"]('User is not enabled');
      const {
        pwd: dbPassword,
        user_salt: userSalt
      } = user;
      ...
      const sessionToken = crypto__WEBPACK_IMPORTED_MODULE_5___default.a.randomBytes(16).toString('base64');
...
/*!***********************!*\
  !*** ./util/index.js ***!
  \***********************/
/*! exports provided: saltHash, generateAccessToken, getExpirationDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
